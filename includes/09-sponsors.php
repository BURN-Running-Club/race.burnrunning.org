<section id="sponsors" class="container-fluid text-center">
	...
	<div class="container">
		<div class="row">
			...
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/tsinghua_logo.png" alt="清华(Tsing Hua)" title="清华(Tsing Hua University)"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/hammer_logo.png" alt="Hammer" title="Hammer"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/unionexpresstravel_logo.png" alt="Union Express Travel" title="Union Express Travel"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/fitgeeksports_logo.png" alt="Fit Geek Sports" title="Fit Geek Sports" />
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/xuchangfu_logo.png" alt="Xu Chang Fu" title="Xu Shi Fu"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/nulifedermspa_logo.png" alt="Nuli" title="Nuli"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/zombie_runner_logo.png" alt="Zombie Runner" title="Zombie Runner"/>
			...
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/marina_logo.png" alt="Marina Sea Food" title="Marina Sea Food"/>
			<img class="col-xs-4 col-sm-3 col-md-2" src="images/sponsors/enspire_logo.png" alt="Enspire" title="Enspire"/>
		</div>
	</div>
</section>
